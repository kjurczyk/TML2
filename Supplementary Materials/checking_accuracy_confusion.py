...
modelDir = "trained_models_like_hw2/"
# training_data_filename = '10_distilled_batch_size_64_5epochs_epochs30_hidden_layers300_rc0.025_acc0.12890000641345978'
model = load_model(modelDir + '10_distilled_batch_size_64_5epochs_epochs5_hidden_layers300_rc0.025_acc0.1551000028848648')   # model = load_model(modelDir + 'first_1000_train_5_8')
#model = load_model(modelDir + 'first_1000_train_epochs5_hidden_layers300_rc0.025_acc0.695900022983551')
...
cm_df = pd.DataFrame(cm,
                     index = ['T-shirt','Trouser','Pullover', 'Dress', 'Coat', 'Sandal', 'Shirt', 'Sneaker', 'Bag', 'Ankleboot'], 
                     columns = ['T-shirt','Trouser','Pullover', 'Dress', 'Coat', 'Sandal', 'Shirt', 'Sneaker', 'Bag', 'Ankleboot'])
