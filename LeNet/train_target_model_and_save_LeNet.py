...
x_attack_train = third_1000_train_images # some images from mnist training data # same as validation
...
x_attack_train = np.pad(x_attack_train, ((0,0),(2,2),(2,2),(0,0)), 'constant')
x_test       = np.pad(x_test, ((0,0),(2,2),(2,2),(0,0)), 'constant')
    
print("Updated Image Shape: {}".format(x_train[0].shape))

# next step of the LeNet architecture
...
X_train, y_train = x_train, to_categorical(y_train)
X_validation, y_validation = x_attack_train, to_categorical(y_attack_train)
...
print('# of validation images:', x_attack_train.shape[0])
...
print('Trained target model on some records. Train accuracy and loss: {:.1f}%, {:.2f} -- Test accuracy and loss: {:.1f}%, {:.2f}'.format(100.0*train_accuracy, train_loss, 100.0*test_accuracy, test_loss))
